...
add_action( 'init', '__wp_supercustom_cms_remove_admin_bar', 0 );

/**
 * Change the var of Admin Bar in WP 3.3
 */
function __wp_supercustom_cms_customize_admin_bar( $admin_bar_keys = array() ) {
 ...
 */
function __wp_supercustom_cms_remove_my_account() {
	
	__wp_supercustom_cms_customize_admin_bar( array( 'my-account' ) );
}

/**
 * Add Logout link to admin abr in wp 3.3
 */
function __wp_supercustom_cms_add_logout( $wp_admin_bar ) {
	...
	if ( '1' === $__wp_supercustom_cms_ui_redirect )
...
function __wp_supercustom_cms_add_user_logout( $wp_admin_bar ) {
...
function __wp_supercustom_cms_set_menu_option_33() {
	...
	switch ( $__wp_supercustom_cms_user_info) {
		case 1:
			add_action( 'wp_before_admin_bar_render', '__wp_supercustom_cms_remove_my_account' );
			break;
		case 2:
			add_action( 'wp_before_admin_bar_render', '__wp_supercustom_cms_remove_my_account' );
			add_action( 'admin_bar_menu', '__wp_supercustom_cms_add_logout', 0 );
			break;
		case 3:
			add_action( 'wp_before_admin_bar_render', '__wp_supercustom_cms_remove_my_account' );
			add_action( 'admin_bar_menu', '__wp_supercustom_cms_add_user_logout', 0 );
			break;
	}
}
...
function __wp_supercustom_cms_restore_links() {
	...
	<div id="wp_supercustom_cms_admin_bar">
		...
		if ( empty( $__wp_supercustom_cms_user_info ) ||
			 ...
			 2 == $__wp_supercustom_cms_user_info || 
			 3 == $__wp_supercustom_cms_user_info ) {
