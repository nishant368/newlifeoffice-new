...
//Load the "framework"
require 'supercustom_shadow_plugin_framework.php';
...
class WPMenuEditor extends MenuEd_ShadowPluginFramework {
	...
	function init(){
		...
		if ( empty($this->option_name) ){
			$this->option_name = 'supercustomcms_menu_editor';
		}
		$this->defaults = array(
		...
		$this->settings_link = 'admin.php?page=WP_SuperCustomCMS';
		...
		add_action( 'wp_ajax_supercustomcms_ame_save_screen_options', array(&$this,'ajax_save_screen_options') );		 
	}
   ...
   */
	function import_settings(){
		$possible_names = array('supercustomcms_menu_editor', 'supercustomcms_menu_editor_pro');
   ...
   */
	function enqueue_styles(){
		wp_enqueue_style('supercustomcms-menu-editor-style', $this->plugin_dir_url . '/css/menu-editor.css', array(), '1.1');
	}
   ...
   */
	function hook_admin_menu(){
		...
		if ( $this->current_user_can_edit_menu() ){
			...
			add_meta_box("supercustomcms-ame-screen-options", "You should never see this", array(&$this, 'noop'), $page);
		}
...
<?php
	...
	asort($all_roles);
?>
<div id='supercustomcms_menu_editor'>
	<div class='supercustomcms_main_container'>
		<div class='supercustomcms_toolbar'>
			<div class="supercustomcms_button_container">		
				<a id='supercustomcms_cut_menu' class='supercustomcms_button' href='javascript:void(0)' title='Cut'><img src='<?php echo $images_url; ?>/cut.png' alt="Cut" /></a>
				<a id='supercustomcms_copy_menu' class='supercustomcms_button' href='javascript:void(0)' title='Copy'><img src='<?php echo $images_url; ?>/page_white_copy.png' alt="Copy" /></a>
				<a id='supercustomcms_paste_menu' class='supercustomcms_button' href='javascript:void(0)' title='Paste'><img src='<?php echo $images_url; ?>/page_white_paste.png' alt="Paste" /></a>
				
				<div class="supercustomcms_separator">&nbsp;</div>
				
				<a id='supercustomcms_new_menu' class='supercustomcms_button' href='javascript:void(0)' title='New menu'><img src='<?php echo $images_url; ?>/page_white_add.png' alt="New menu" /></a>
				<a id='supercustomcms_hide_menu' class='supercustomcms_button' href='javascript:void(0)' title='Show/Hide'><img src='<?php echo $images_url; ?>/plugin_disabled.png' alt="Show/Hide" /></a>
				<a id='supercustomcms_delete_menu' class='supercustomcms_button' href='javascript:void(0)' title='Delete menu'><img src='<?php echo $images_url; ?>/page_white_delete.png' alt="Delete menu" /></a>
				
				<div class="supercustomcms_separator">&nbsp;</div>
				
				<a id='supercustomcms_new_separator' class='supercustomcms_button' href='javascript:void(0)' title='New separator'><img src='<?php echo $images_url; ?>/separator_add.png' alt="New separator" /></a>
			</div>
		</div>
		
		<div id='supercustomcms_menu_box' class="supercustomcms_box">
		</div> 
	</div>
	<div class='supercustomcms_main_container'>
		<div class='supercustomcms_toolbar'>
			<div class="supercustomcms_button_container">
				<a id='supercustomcms_cut_item' class='supercustomcms_button' href='javascript:void(0)' title='Cut'><img src='<?php echo $images_url; ?>/cut.png' alt="Cut" /></a>
				<a id='supercustomcms_copy_item' class='supercustomcms_button' href='javascript:void(0)' title='Copy'><img src='<?php echo $images_url; ?>/page_white_copy.png' alt="Copy" /></a>
				<a id='supercustomcms_paste_item' class='supercustomcms_button' href='javascript:void(0)' title='Paste'><img src='<?php echo $images_url; ?>/page_white_paste.png' alt="Paste" /></a>
				
				<div class="supercustomcms_separator">&nbsp;</div>
				
				<a id='supercustomcms_new_item' class='supercustomcms_button' href='javascript:void(0)' title='New menu item'><img src='<?php echo $images_url; ?>/page_white_add.png' alt="New menu item" /></a>
				<a id='supercustomcms_hide_item' class='supercustomcms_button' href='javascript:void(0)' title='Show/Hide'><img src='<?php echo $images_url; ?>/plugin_disabled.png' alt="Show/Hide" /></a>
				<a id='supercustomcms_delete_item' class='supercustomcms_button' href='javascript:void(0)' title='Delete menu item'><img src='<?php echo $images_url; ?>/page_white_delete.png' alt="Delete menu item" /></a>
				
				<div class="supercustomcms_separator">&nbsp;</div>
				
				<a id='supercustomcms_sort_ascending' class='supercustomcms_button' href='javascript:void(0)' title='Sort ascending'>
					<img src='<?php echo $images_url; ?>/sort_ascending.png' alt="Sort ascending" />
				</a>
				<a id='supercustomcms_sort_descending' class='supercustomcms_button' href='javascript:void(0)' title='Sort descending'>
					<img src='<?php echo $images_url; ?>/sort_descending.png' alt="Sort descending" />
				</a>
			</div>
		</div>
		
		<div id='supercustomcms_submenu_box' class="supercustomcms_box">
		</div>
	</div>
</div>

<div class="supercustomcms_main_container" id="supercustomcms_editor_sidebar">

	
	<input type="button" id='supercustomcms_reset_menu' value="Undo changes" class="button supercustomcms_main_button" />
	<input type="button" id='supercustomcms_load_menu' value="Load default menu" class="button supercustomcms_main_button" />
...
<?php
	...
	$capSelector = array('<select id="supercustomcms_cap_selector" class="supercustomcms_dropdown" size="10">');
	...
	$capSelector[] = '<optgroup label="Roles">';
 	...
 	$pageSelector = array('<select id="supercustomcms_page_selector" class="supercustomcms_dropdown" size="10">');
...
<span id="supercustomcms-ame-screen-meta-contents" style="display:none;">
<label for="supercustomcms-hide-advanced-settings">
	<input type="checkbox" id="supercustomcms-hide-advanced-settings"<?php 
...
var hideAdvancedSettingsNonce = '<?php echo esc_js(wp_create_nonce('supercustomcms_ame_save_screen_options'));  ?>';
...
window.wsMenuEditorPro = false; //Will be overwritten if extras are loaded
	...
	function print_uservoice_widget(){
		...
		(function($){
			$('#screen-meta-links').append(
				'<div id="supercustomcms-ame-feedback-widget-wrap">' +
					'<a href="http://feedback.w-shadow.com/forums/58572-admin-menu-editor" id="supercustomcms-ame-feedback-widget" class="show-settings" target="_blank" title="Open the user feedback forum">Feedback</a>' +
				'</div>'
			);
		})(jQuery);
		</script>
   ...
   */
	function print_upgrade_notice(){
		...
		(function($){
			$('#screen-meta-links').append(
				'<div id="supercustomcms-pro-version-notice">' +
					'<a href="http://wpplugins.com/plugin/146/admin-menu-editor-pro" id="supercustomcms-pro-version-notice-link" class="show-settings" target="_blank" title="View Pro version details">Upgrade to Pro</a>' +
				'</div>'
			);
		})(jQuery);
		</script>
	 ...
	 * 
	 * Handles the 'supercustomcms_ame_save_screen_options' action. The new option value 
	 * is read from $_POST['hide_advanced_settings'].
	 * 
	 * @return void
	 */
	function ajax_save_screen_options(){
		if (!current_user_can('manage_options') || !check_ajax_referer('supercustomcms_ame_save_screen_options', false, false)){
