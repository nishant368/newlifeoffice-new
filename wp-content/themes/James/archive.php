<?php get_header(); ?>
<div class="container">
<div class="shadowTop"><h2 class="entry-title"><?php if ( is_day() ) : ?>
<?php _e( 'Daily Archives: ', 'tdCore' ); ?><span><?php echo get_the_date() ?></span>
<?php elseif ( is_month() ) : ?>
<?php _e( 'Monthly Archives: ', 'tdCore' ); ?><span><?php echo get_the_date( 'F Y' ) ?></span>
<?php elseif ( is_year() ) : ?>
<?php _e( 'Yearly Archives: ', 'tdCore' ); ?><span><?php echo get_the_date( 'Y' ) ?></span>
<?php else : ?>
<?php _e( 'Blog Archives', 'tdCore' ); ?>
<?php endif; ?></h2><div class="clickHide"></div></div>
<div class="content">
