...
function slideToggle() {
	jQuery('#smartSeo_fields .title h3').parent().next('.option_content').hide();
    var initChar;
    jQuery('#smartSeo_fields .title h3').click(function(){
...
jQuery(document).ready(function(){
    ...
    tooltip();
	jQuery('.forminp textarea').focus(function() { jQuery(this).css("background-color", "#ffffff") })
});
