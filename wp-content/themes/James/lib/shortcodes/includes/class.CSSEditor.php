...
class CSSEditor {
	...
	function media_buttons_context($context){
        $out = '<a href="#TB_inline?width=1000&inlineId=insert_csshortcode" class="thickbox" title="'. __("TD Shortcode generator", 'wpcss').'"><img src="'.WPCSS_URL."css/images/icon_shortcodes.png".'" alt="'. __("Add Styles with Shortcodes", 'wpcss') . '" /></a>';
