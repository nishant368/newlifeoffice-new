...
<div class="part2">
				<div class="box-center pgsize2  <?php echo $GLOBALS['set_style']; ?>">
					...
					<div class="inside">
						...
						<h1 class="page-title author"><?php printf( __( 'Author Archives: %s', 'fullscreen' ), "<span class='vcard'><a class='url fn n' href='" . get_author_posts_url( get_the_author_meta( 'ID' ) ) . "' title='" . esc_attr( get_the_author() ) . "' rel='me'>" . get_the_author() . "</a></span>" ); ?></h1>
										...
										if ( get_the_author_meta( 'description' ) ) : ?>
															<div id="entry-author-info">
																...
																<div id="author-description">
																	<h2><?php printf( __( 'About %s', 'fullscreen' ), get_the_author() ); ?></h2>
